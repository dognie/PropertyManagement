...
/**
 * Api services for the `OrganizationRole` model.
 *
 * **Details**
 *
 * 角色
 */
@Injectable()
export class OrganizationRoleApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `OrganizationRole` object.)
   * </em>
   */
  public getOrganization(id: any, refresh: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/OrganizationRoles/:id/organization";
  ...
  public addRoles(id: any, role: any): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/OrganizationRoles/:id/roles/:role";
    let _routeParams: any = {
      id: id,
      role: role
    };
